...
public interface ShowAllProductMapper {
    ...
    int countTotalProductCate(@Param("cateCd") String cateCd,@Param("userId") Integer userId);

    int countTotalProductUser(@Param("cateCd") String cateCd,@Param("userId") Integer userId);
